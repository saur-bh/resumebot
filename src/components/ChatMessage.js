          ...
          <div className={`chat-bubble ${isUser ? 'chat-bubble-user' : 'chat-bubble-bot'} backdrop-blur-md`}>
            {isBot ? (
              <div className="prose prose-sm max-w-none">
                  ...
                  <div className="mt-4 w-full">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                      {message.videos.map((video) => (
                        <div key={video.id} className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20 hover:border-red-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-red-500/20">
                          <div className="text-center">
                            ...
                            {/* Video Info */}
                            <h4 className="font-semibold text-white text-sm mb-2 leading-tight">{video.title}</h4>
                            <p className="text-gray-300 text-xs mb-3">Click thumbnail to watch on YouTube</p>
                            ...
                            <a 
                              ...
                              target="_blank" 
                              rel="noopener noreferrer"
                              className="inline-flex items-center space-x-1 px-3 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors text-xs font-medium w-full justify-center"
                            >
                ...
                {message.website && (
                  <div className="mt-4 w-full">
                    <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20 hover:border-blue-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/20">
                      {/* Header */}
                      <div className="flex items-center space-x-2 mb-3">
                        <span className="text-lg">🌐</span>
                        <span className="text-sm font-medium text-white">Personal Website Preview</span>
                      </div>
                      ...
                      <div className="mt-3 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
                        <p className="text-xs text-gray-300">{message.website.description}</p>
                        <a 
                          href={message.website.url} 
                          target="_blank" 
                          rel="noopener noreferrer"
                          className="inline-flex items-center space-x-1 px-3 py-1 bg-blue-500 text-white text-xs rounded-full hover:bg-blue-600 transition-colors"
                        >
                  ...
                  <div className="mt-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                      {message.certifications.map((cert) => (
                        <div key={cert.id} className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20 hover:border-blue-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/20">
                          <div className="text-center">
                            {/* Certification Icon */}
                            ...
                            {/* Certification Info */}
                            <h4 className="font-semibold text-white text-sm mb-2 leading-tight">{cert.title}</h4>
                            <p className="text-gray-300 text-xs mb-2">{cert.description}</p>
                            <p className="text-blue-400 text-xs mb-3 font-medium">{cert.issuer}</p>
                            ...
                            <a 
                              ...
                              target="_blank" 
                              rel="noopener noreferrer"
                              className="inline-flex items-center space-x-1 px-3 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors text-xs font-medium w-full justify-center"
                            >
                              <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="mt-4 w-full">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                      {message.articles.map((article) => (
                        <div key={article.id} className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20 hover:border-orange-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-orange-500/20">
                          <div className="text-center">
                            {/* Medium Icon */}
                            ...
                            {/* Article Info */}
                            <h4 className="font-semibold text-white text-sm mb-2 leading-tight">{article.title}</h4>
                            <p className="text-gray-300 text-xs mb-3 line-clamp-2">{article.description}</p>
                            ...
                            <a 
                              ...
                              target="_blank" 
                              rel="noopener noreferrer"
                              className="inline-flex items-center space-x-1 px-3 py-2 bg-orange-500 text-white rounded-lg hover:bg-orange-600 transition-colors text-xs font-medium w-full justify-center"
                            >
                              <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M13.54 12a6.8 6.8 0 01-6.77 6.82A6.8 6.8 0 010 12a6.8 6.8 0 016.77-6.82A6.8 6.8 0 0113.54 12zM20.96 12c0 3.54-1.51 6.42-3.38 6.42-1.87 0-3.39-2.88-3.39-6.42s1.52-6.42 3.39-6.42 3.38 2.88 3.38 6.42M24 12c0 3.17-.53 5.75-1.19 5.75-.66 0-1.19-2.58-1.19-5.75s.53-5.75 1.19-5.75S24 8.83 24 12z"/>
                              </svg>
